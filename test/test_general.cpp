...
public:
  ...
  int test_float()
  {
    ...
    test_one_float(+1.00, +0x40000000, +1);
    test_one_float(-1.00, -0x40000000, +1);

    test_one_float(+0.50, +0x40000000, 0);
    test_one_float(-0.50, -0x40000000, 0);

    test_one_float(+0.25, +0x40000000, -1);
    test_one_float(-0.25, -0x40000000, -1);

    test_one_float(+0.125, +0x40000000, -2);
    test_one_float(-0.125, -0x40000000, -2);
  ...
  int test_byteorder()
  {
    ...
    ///////////////////////////////////////////////////////
    // Big endian write test (int2lexx functions)
