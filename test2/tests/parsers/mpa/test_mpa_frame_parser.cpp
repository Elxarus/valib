...
{                             // ver layer err | bitrate | sf pad priv | mode ext | cpr orig emph
  { 0xff, 0xf2, 0x00, 0x00 }, //  0   01    0     0000     00  0    0     00  00     0   0    00
  { 0xff, 0xf3, 0x10, 0x10 }, //  0   01    1     0001     00  0    0     00  01     0   0    00
  { 0xff, 0xf4, 0x22, 0x20 }, //  0   10    0     0010     00  1    0     00  10     0   0    00
  { 0xff, 0xf5, 0x37, 0x30 }, //  0   10    1     0011     01  1    1     00  11     0   0    00
  { 0xff, 0xf6, 0x45, 0x40 }, //  0   11    0     0100     01  0    1     01  00     0   0    00
  { 0xff, 0xf7, 0x55, 0x50 }, //  0   11    1     0101     01  0    1     01  01     0   0    00
  { 0xff, 0xf2, 0x6a, 0x60 }, //  0   01    0     0110     10  1    0     01  10     0   0    00
  { 0xff, 0xf5, 0x7a, 0x70 }, //  0   10    1     0111     10  1    0     01  11     0   0    00
  { 0xff, 0xfa, 0x88, 0x80 }, //  1   01    0     1000     10  0    0     10  00     0   0    00
  { 0xff, 0xfb, 0x91, 0x90 }, //  1   01    1     1001     00  0    1     10  01     0   0    00
  { 0xff, 0xfc, 0xa7, 0xa0 }, //  1   10    0     1010     01  1    1     10  10     0   0    00
  { 0xff, 0xfd, 0xbb, 0xb0 }, //  1   10    1     1011     10  1    1     10  11     0   0    00
  { 0xff, 0xfe, 0xc0, 0xc0 }, //  1   11    0     1100     00  0    0     11  00     0   0    00
  { 0xff, 0xff, 0xd4, 0xd0 }, //  1   11    1     1101     01  0    0     11  01     0   0    00
  { 0xff, 0xfa, 0xea, 0xe0 }, //  1   01    0     1110     10  1    0     11  10     0   0    00
